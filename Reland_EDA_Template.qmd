...
heightplot <- trans_height |>
  ...
  #facet_wrap(~ Transect_Num, scales = "free_y", labeller = labeller(Transect_Num = c("1" = "Transect 1", "2" = "10/04/18 2", "3" = "Transect 3", "4" = "Transect 4", "5" = "Transect 5", "6" = "Transect 6", "7" = "06/13/18 7", "8" = "Transect 8", "9" = "Transect 9", "10" = "06/13/18 10", "11" = "Transect 11", "12" = "Transect 12"))) +
